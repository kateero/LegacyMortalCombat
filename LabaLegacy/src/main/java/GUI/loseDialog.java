...
public class loseDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(243, 131, 117));

        jLabel1.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Игра окончена");

        jLabel2.setFont(new java.awt.Font("Georgia", 0, 22)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("К сожалению, Вы проиграли");

        jButton1.setBackground(new java.awt.Color(140, 114, 132));
